...
<script type="text/ecmascript-6">
  ...
  export default {
    created() {
      this.touch = {}  // 在VUE的data,props,computed中定义的变量都自动添加get,set这2个方法，兼听数据发生变生而做双向数据绑定。这里定义touch不是为了双向绑定，只是为了在几个地方使用。
    ...
    methods: {
      ...
      onShortcutTouchMove(e) {
        ...
        let delta = (this.touch.y2 - this.touch.y1) / ANCHOR_HEIGHT | 0   //  “|”是转换成2进制后，二者相加
